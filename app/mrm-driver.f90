...
program driver
  ...
  parser = cli_parser( &
    description="The mesoscale routing model - mRM v2", &
  ...
  call parser%add_option( &
    ...
    value_name="path", &
    default="mrm.nml", &
    help="The mRM configuration namelist.")
  ...
  do i = 1_i4, size(selected_domains)
    ...
    call domain%configure(parameters=parameters, time_cfg=time_cfg, input_cfg=input_cfg, mrm_cfg=mrm_cfg)
  end do
