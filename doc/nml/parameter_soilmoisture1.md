# Soil moisture - Case 1 {#soilmoisture1}

[TOC]

Feddes equation for ET reduction, multi-layer infiltration capacity approach, Brooks-Corey like
...
- Type: `real(dp), dimension(5)`
- Required: yes
- Examples: `[0.75, 0.8, 0.788, 1.0, 1.0]`
...
- Type: `real(dp), dimension(5)`
- Required: yes
- Examples: `[0.0008, 0.0012, 0.001, 1.0, 1.0]`
...
- Type: `real(dp), dimension(5)`
- Required: yes
- Examples: `[-0.27, -0.25, -0.263, 1.0, 1.0]`
...
- Type: `real(dp), dimension(5)`
- Required: yes
- Examples: `[0.8, 0.9, 0.8907, 1.0, 1.0]`
...
- Type: `real(dp), dimension(5)`
- Required: yes
- Examples: `[-0.0012, -0.0008, -0.001, 1.0, 1.0]`
...
- Type: `real(dp), dimension(5)`
- Required: yes
- Examples: `[-0.35, -0.3, -0.322, 1.0, 1.0]`
...
```fortran
&soilmoisture1
  orgMatterContent_forest(:) = 5.0, 10.0, 7.0, 1.0, 1.0
  orgMatterContent_impervious(:) = 0.0, 1.0, 0.5, 1.0, 1.0
  orgMatterContent_pervious(:) = 1.0, 5.0, 2.5, 1.0, 1.0
  PTF_lower66_5_constant(:) = 0.75, 0.8, 0.788, 1.0, 1.0
  PTF_lower66_5_clay(:) = 0.0008, 0.0012, 0.001, 1.0, 1.0
  PTF_lower66_5_Db(:) = -0.27, -0.25, -0.263, 1.0, 1.0
  PTF_higher66_5_constant(:) = 0.8, 0.9, 0.8907, 1.0, 1.0
  PTF_higher66_5_clay(:) = -0.0012, -0.0008, -0.001, 1.0, 1.0
  PTF_higher66_5_Db(:) = -0.35, -0.3, -0.322, 1.0, 1.0
